-- unit_prices 테이블 DROP 후 재생성 (20개 공종)
...
-- 철거
('철거', '바닥재 철거',            'm2',      3000,  15000,  18000),
('철거', '벽체 타일 철거',         'm2',      5000,  17000,  22000),
('철거', '천장 철거',              'm2',      3000,  17000,  20000),
('철거', '문짝 철거',              '개',      5000,  30000,  35000),
('철거', '벽체 철거 조적',         'm2',      8000,  22000,  30000),
-- 마루철거
('마루철거', '강마루 철거',        'm2',      2000,  10000,  12000),
('마루철거', '원목마루 철거',      'm2',      3000,  12000,  15000),
('마루철거', '장판 철거',          'm2',      1000,   6000,   7000),
-- 설비
...
-- 타일
('타일', '타일 300x300',           'm2',     30000,  35000,  65000),
('타일', '타일 600x600',           'm2',     40000,  40000,  80000),
('타일', '욕실 타일',              'm2',     45000,  45000,  90000),
('타일', '현관 타일',              'm2',     35000,  40000,  75000),
-- 도장
('도장', '내부 도장 2회',          'm2',      4000,  10000,  14000),
('도장', '외부 도장',              'm2',      8000,  12000,  20000),
('도장', '목공 도장 PU',           'm2',     12000,  18000,  30000),
('도장', '페인트 친환경',          'm2',      6000,  10000,  16000),
-- 필름
('필름', '인테리어 필름 단색',     'm2',     12000,  13000,  25000),
('필름', '인테리어 필름 패턴',     'm2',     18000,  17000,  35000),
('필름', '시트지 시공',            'm2',      8000,  10000,  18000),
-- 도배
('도배', '합지 도배',              'm2',      3000,   6000,   9000),
('도배', '실크 도배',              'm2',      5000,   9000,  14000),
('도배', '방염 도배',              'm2',      7000,  10000,  17000),
-- 욕실도기
...
-- 바닥
('바닥', '강마루 시공',            'm2',     25000,  30000,  55000),
('바닥', '원목마루 시공',          'm2',     70000,  50000, 120000),
('바닥', '에폭시 도장',            'm2',     15000,  25000,  40000),
('바닥', 'LVT 바닥재',             'm2',     20000,  25000,  45000),
('바닥', '데코타일',               'm2',     12000,  18000,  30000),
-- 가구
...
('유리실리콘', '강화유리 설치',    'm2',     80000,  70000, 150000),
-- 공조
('공조', '시스템 에어컨 설치',     '대',   1000000, 500000,1500000),
('공조', '환기장치 천장형',        '대',    300000, 200000, 500000),
('공조', '덕트 시공',              'm',      15000,  15000,  30000),
-- 홈스타일링
('홈스타일링', '커텐 암막',        'm2',     40000,  20000,  60000),
('홈스타일링', '블라인드 롤',      'm2',     25000,  15000,  40000),
('홈스타일링', '거울 설치',        '개',     80000,  70000, 150000),
('홈스타일링', '아트월 시공',      'm2',     50000,  50000, 100000);
